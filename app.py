...
def download_response(child_id):
    ...
    if child.get('wanted_behavior'):
        ...
        recommendation = f"Now listen to your parents and remember the spirit of Christmas all year long!"
...
def download_letter(child_id):
    ...
    if int(child.get('age')) < 7:
        ...
        ps = f"P.S. Say 'hi' to {child.get('say_hi1')} and {child.get('say_hi2')} for me!"
